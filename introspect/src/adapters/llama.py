"""LLaMA-family model adapter implementation."""
...
@dataclass
class LlamaAdapter:
    """Adapter for HuggingFace LLaMA-style causal language models."""

    model_id: str
    tokenizer: PreTrainedTokenizer
    model: PreTrainedModel

    name: str = "LlamaAdapter"
    ...
    def load(
        ...
        *,
        ...
        """Load a LLaMA-family model using the provided configuration."""
    ...
    def tokens_for_spans(self, text: str, span_slices: Sequence[SpanSlice]) -> list[int]:
        ...
        if offsets is None:
            msg = "Tokenizer must provide offset mapping for span alignment"
        ...
        unique_indices = list(dict.fromkeys(selected))
